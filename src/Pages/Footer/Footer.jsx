        ...
        <div>
            <footer
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
                    ...
                    <h1 className="text-[40px] font-bold text-orange-500 italic gap-0">FFreelancer<span className="text-emerald-600 text-[50px]">.</span></h1>
                        <p className="mt-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">© 2023 all right reserved by Online Marketplace.</p>
                    </div>
                    {/* <!-- End Col --> */}
